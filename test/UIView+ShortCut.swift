...
public extension UIView {
    ...
    func makeCornerRadius(_ cornerRadius : CGFloat?=nil,borderColor:UIColor?=nil,borderWidth:CGFloat?=nil) {
    ...
    convenience init(bgColor:UIColor,cornerRadius:CGFloat?=nil,borderColor:UIColor?=nil,borderWidth:CGFloat?=nil) {
        self.init()
